...
public class SimuladorPage extends SimuladorBasePage {
	...
	public void preencherCamposDatela(String valorAplicar, String valorInvestir, String tempo,
			String blocoResultadoSimulacao) {
	...
	public void cliqueBotaoSimular() {
		clique(By.xpath("//button[@class='btn btnAmarelo btnSimular']"));
	}
	...
	public void cliqueBotaoRefazerSimulacao() {
		clique(By.xpath("//button[@class='btn btnAmarelo btnRefazer']"));
		//class="btn btnAmarelo btnRefazer"
